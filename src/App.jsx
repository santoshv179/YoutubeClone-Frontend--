...
// // const ChannelFormPage = lazy(() => import('./pages/ChannelFormPage'))
...
//               {/* The new settings route must come BEFORE the dynamic route */}
//               <Route path="/channel/settings" element={<ChannelSettingsPage />} />

//               <Route path="/channel/:id" element={<ChannelPage />} />
//               <Route path="/search" element={<SearchResultsPage />} /> {/* Add this new search route */}
//               <Route path="/login" element={<LoginPage />} />
//               <Route path="/register" element={<RegisterPage />} />
//               <Route path="/create-channel" element={<CreateChannelPage />} />
//               <Route path="/upload" element={<UploadPage />} />
//               <Route path="/channel/settings/:id" element={<ChannelSettingsPage />} />
